...
<span id="cadreCreationNews" class="whiteText">
    <form class="cadreVert" action="../PHP/creationNews.php" method="post">
        <div>
            ...
            <br>
            <input required type="text" placeholder="Titre de la news" id="titreNews" name="titre" />
        </div>
        <div>
            <label for="texteNews">*Texte de la news :</label>
            <br>
            <textarea required placeholder="Texte de la news" id="texteNews" name="texte" ></textarea>
        </div>
        <div>
...
<span id="cadreCreationActivite" class="whiteText">
    <form class="cadreVert" action="../PHP/creationActivite.php" method="post">
        <div>
            ...
            <br>
            <input type="text" required placeholder="Titre de l'activité" id="titreActivit" name="titre" />
        </div>
        <div>
            <label for="texteActivit">*Texte de l'activité :</label>
            <br>
            <textarea placeholder="Texte de l'activité" required id="texteActivit" name="texte" ></textarea>
        </div>
        <div>
            <label for="dateActivit">*Date de l'évenement :</label>
            <br>
            <input type="text" id="dateActivit" required placeholder="18 février 2016 à 18H30" name="date" /><br><br>
        </div>
        <p>* Obligatoire &nbsp;</p>
        <input class="blackText" type="submit" name="Valider" />
    </form>
